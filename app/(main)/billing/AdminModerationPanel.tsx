...
export default function AdminModerationPanel() {
  ...
  return (
    <section className="mt-8 rounded-3xl border border-rose-100 dark:border-rose-500/20 bg-gradient-to-br from-rose-50 dark:from-rose-500/10 via-white dark:via-slate-900 to-amber-50 dark:to-amber-500/10 p-6 md:p-8">
      <div className="mb-6">
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Community Controls</h2>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <div className="rounded-2xl border border-white/70 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 p-5 shadow-sm">
          <h3 className="text-base font-semibold text-slate-900 dark:text-slate-100">Delete Post</h3>
          <input
            value={deletePostId}
            onChange={(event) => setDeletePostId(event.target.value)}
            placeholder="Post ID"
            className="mt-4 w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-transparent dark:bg-slate-800 px-3 py-2.5 text-sm outline-none transition focus:border-rose-400 focus:ring-2 focus:ring-rose-100 dark:focus:ring-rose-500/20 dark:text-slate-100"
          />
          <button
            onClick={handleDeletePost}
            disabled={loadingAction === "deletePost"}
            className="mt-4 inline-flex w-full items-center justify-center rounded-xl bg-rose-600 dark:bg-rose-500 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-rose-500 dark:hover:bg-rose-400 disabled:cursor-not-allowed disabled:opacity-70"
          >
        ...
        <div className="rounded-2xl border border-white/70 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 p-5 shadow-sm">
          <h3 className="text-base font-semibold text-slate-900 dark:text-slate-100">Delete Comment</h3>
          <input
        ...
        <div className="rounded-2xl border border-white/70 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 p-5 shadow-sm">
          ...
          <input
            ...
            className="mt-3 w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-transparent dark:bg-slate-800 px-3 py-2.5 text-sm outline-none transition focus:border-rose-400 focus:ring-2 focus:ring-rose-100 dark:focus:ring-rose-500/20 dark:text-slate-100"
          />
          <button
